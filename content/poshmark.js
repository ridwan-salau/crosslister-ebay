// content/poshmark.js — Poshmark listing form bootstrap (stub)
// TODO: Wire up after poshmarkConfig.js is populated with real selectors
...
(async function init() {
  ...
  safeSendMessage({ action: 'GET_STAGED_LISTING' }, async (response) => {
    ...
    bannerObj.el.onclick = async () => {
      ...
      const result = await fillForm(poshmarkConfig, response.item, settings);
